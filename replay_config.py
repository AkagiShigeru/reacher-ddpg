...
experiment_path = os.path.join(os.getcwd(), "experiments", "20191210-150645")
...
train_model = False  # if False, will show trained agent, if True: will train new model and save weights in above path
